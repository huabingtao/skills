...
def main():
    parser = argparse.ArgumentParser(description="xiaohongshu-publisher-skill: 上传图文至小红书草稿箱")
    ...
    if args.login:
        with sync_playwright() as pw:
            from xhs_uploader import login
            login(pw)
        return
    ...
    with sync_playwright() as pw:
        from xhs_uploader import upload_image_post
        upload_image_post(
            pw,
